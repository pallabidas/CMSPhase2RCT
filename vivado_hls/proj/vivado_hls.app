<project xmlns="com.autoesl.autopilot.project" name="proj" top="algo_unpacked">
    <libraryPaths/>
    ...
    <files xmlns="">
        ...
        <file name="src/bitonicFun256.cpp" sc="0" tb="false" cflags=""/>
        <file name="src/bitonicSort256.cpp" sc="0" tb="false" cflags=""/>
        <file name="src/bitonicSort128Inc.cpp" sc="0" tb="false" cflags=""/>
        <file name="src/bitonicSort128Dec.cpp" sc="0" tb="false" cflags=""/>
        <file name="src/bitonicSort64Inc.cpp" sc="0" tb="false" cflags=""/>
        <file name="src/bitonicSort64Dec.cpp" sc="0" tb="false" cflags=""/>
