...
#pragma HLS ARRAY_RESHAPE variable=rIdx_tau complete dim=1
#pragma HLS ARRAY_RESHAPE variable=sr_et complete dim=1
#pragma HLS ARRAY_RESHAPE variable=sr_et_tau complete dim=1
#pragma HLS ARRAY_RESHAPE variable=sr_et_tau_Iso complete dim=1
...
#pragma HLS UNROLL
	...
	{
#pragma HLS UNROLL
		nonIso_tau_et[idx] = sr_et_tau[idx];
		Iso_tau_et[idx] = sr_et_tau_Iso[idx];
		rIdx_tau[idx] = sr_idx[idx];
	}
